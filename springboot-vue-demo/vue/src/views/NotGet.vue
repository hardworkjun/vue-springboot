<template>
  ...
  <div style="width: 90%;padding-bottom: 50px; font-weight: 600;" >
    ...
    <div  style="top: 140px;width: 90%">
      ...
      <el-table :data="tableData" border  style="width: 100%;margin-left: 30px; "> 
          ...
          <span v-if="scope.row.pusher==='0'">未发货</span>
          <span v-if="scope.row.pusher==='1'">已发货</span>
          </template>
        </el-table-column>
  ...
  />
   ...
   <!-- 查看详情弹窗 -->
   <el-dialog v-model="dialogVisible" title="查看订单详情" width="40%" id="bg01">
